...
nohup virt-install --name="$distro" --vcpus="$cpu" --graphics spice --network network=default --memory="$mem" --cdrom="/home/jake/Media/iso/$iso" --disk size="$gb" --os-variant="$os" --boot "$boot" &
